...
parser.add_argument("--roi_x", default=8, type=int, help="roi size in x direction")
parser.add_argument("--roi_y", default=8, type=int, help="roi size in y direction")
parser.add_argument("--roi_z", default=8, type=int, help="roi size in z direction")
