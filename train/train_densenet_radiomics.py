...
parser.add_argument("--roi_x", default=4, type=int, help="roi size in x direction")
parser.add_argument("--roi_y", default=4, type=int, help="roi size in y direction")
parser.add_argument("--roi_z", default=4, type=int, help="roi size in z direction")
